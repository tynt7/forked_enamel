...
public class testDataButton {
	...
	/**
	 * tests add Texts Method. Method should append new text in new Line if
	 * getText is not an empty string
	 */
	@Test
	public void testAddText() {
		...
		assertTrue("Wrong text1",
				(dataButton.getText().equals("Hello" + "\n" + " World\nNew Line\nAnother New Line\nEnd Line")));
		assertEquals("Wrong Text", dataButton.getText(), "Hello\n World" + "\nNew Line\nAnother New Line\nEnd Line");
	}
	...
	/**
	 * Tests setText Method Method should overwrite button text field.
	 */
	@Test
